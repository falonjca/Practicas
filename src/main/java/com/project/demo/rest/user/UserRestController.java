...
public class UserRestController {
    ...
    public ResponseEntity<?> getAll(
        ...
        return new GlobalResponseHandler().handleResponse("Usuarios devueltos exitosamente",
    ...
    public ResponseEntity<?> addUser(@RequestBody User user, HttpServletRequest request) {
        ...
        return new GlobalResponseHandler().handleResponse("Usuarios actualizados exitosamente",
    ...
    public ResponseEntity<?> updateUser(@PathVariable Long userId, @RequestBody User user, HttpServletRequest request) {
        ...
        if(foundOrder.isPresent()) {
            ...
            return new GlobalResponseHandler().handleResponse("Usuario id " + userId + " no encontrado"  ,
